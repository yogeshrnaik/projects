...
<h3>
	<spring:message code="page.search.employee.by.skill.result.header" /> for '${skillSearched.name}'
</h3>
	...
	<table border="1" cellspacing="5" cellpadding="5">
		...
		<c:forEach items="${employees}" var="employee">
			<tr>
				...
				<td><a href="<c:url value='/showEditEmployee/${employee.id}' />"><spring:message code="link.edit" /></a></td>
				<td><a href="<c:url value='/deleteEmployee/${employee.id}' />"><spring:message code="link.delete" /></a></td>
			</tr>
		</c:forEach>
	</table>
</c:if>